...
public class Article4 {
    ...
    public Article4 copyFrom(Article4 source) {
        this._datePublished = source.getDatePublished();
        this._dateCreated = source.getDateCreated();
        this._wordCount = source.getWordCount();
        this._author = source.getAuthor();
        this._rating = source.getRating();
        this._genre = source.getGenre();
        this._language = source.getLanguage();
        this._text = source.getText();
        this._version = source.getVersion();
        this._url = source.getUrl();
        this._tags = source.getTags();
        this._headLine = source.getHeadLine();
        return this;
    }
